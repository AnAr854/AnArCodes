...
function Matopeli (){
    if(window.innerWidth >= 1024){
        ...
        <>
            ...
            <p>Pelin repositorion löydät täältä: </p><a className="githubLink" href="https://github.com/AnAr854/WormGame" target="_blank" rel="noreferrer">Matopelin repositorio</a>
        </>
        )
    }
}
