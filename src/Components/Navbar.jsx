      ...
      return (
        ...
        <TabContext value={value}>
          <TabList className="navLinks" value={value} onChange={handleChange} aria-label="my projects choosing tabs">
            <Tab href= "#jumpToContent" label="Fribago" icon={ <img src={require('../../src/img//Fribago/fribago_logo.ico')} alt="Fribago logo"/>} iconPosition='end' value="Fribago" style={{ fontSize: '1.5em', fontWeight: 600, fontFamily: '"Baloo Paaji 2"', color: '#7cffd5', padding: 0 }}/>
          ...
          <TabList className="navLinks2" value={value} onChange={handleChange} aria-label="third projects choosing tabs">
            <Tab href= "#jumpToContent" icon={ <img src={require('../../src/img//Kirjanpitaja/kirjanpitaja_logo.png')} alt="Kirjanpitäjä logo" height="45" backgroundcolor="#98B252"/>}  value="Kirjanpitaja"/>
