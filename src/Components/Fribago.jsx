...
function Fribago (){
    return(
        <>
            ...
            <ul>
              <li><a  className="fribagoTeam" href="https://www.linkedin.com/in/antti-mutanen-b72981261/" target="_blank">Antti Mutanen</a></li>
              <li><a className="fribagoTeam" href="https://www.linkedin.com/in/marinieminen1001101/" target="_blank">Mari Nieminen</a></li>
              <li><a  className="fribagoTeam" href="https://www.linkedin.com/in/eeva-arhipoff/" target="_blank">Eeva Arhipoff</a></li>
            </ul>
